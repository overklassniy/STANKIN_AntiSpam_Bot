...
| Папка / файл | Описание |
| --- | --- |
| [`01_data_preparation/`](01_data_preparation/README.md) | Загрузка, очистка, балансировка, препроцессинг данных и подготовка тестового датасета |
...
1. `01_data_preparation/` (01a -> 01b -> 01c -> 01d -> 01e) — подготовка train и test датасетов
2. `02_data_quality.ipynb` — оценка качества данных
3. `03_classical_baselines/` (03a -> 03b -> 03c) — классические модели
