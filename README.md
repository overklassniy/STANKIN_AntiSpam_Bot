...
В исследовании используются следующие внешние источники данных:

- [LOLS](https://lols.bot/) — сервис разметки и проверки спам-сообщений
- [ruSpamModels/russian-spam-detection](https://huggingface.co/datasets/ruSpamModels/russian-spam-detection) — датасет для обнаружения русскоязычного спама на Hugging Face
